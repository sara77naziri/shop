        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('products.create')}}"><i class="mdi mdi-toggle-switch-off"></i>ایجاد محصول جدید</a></li>
                        <li><a href="{{route('products.index')}}"><i class="mdi mdi-toggle-switch-off"></i> لیست محصولات </a></li>
                    </ul>
                </li>
